...
> **Note:** This is the original implementation plan, written before any
> code existed. It's kept here as historical context for the design
> decisions below — the "Milestone Roadmap" and "Open Decisions" sections
> in particular predate the actual implementation and don't necessarily
> reflect the current code exactly.
